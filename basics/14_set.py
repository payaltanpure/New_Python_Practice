...
js= {"ram", "rahul", "radha"}
ps= {"ram", "rahul", "komal","sakshi", "om"}

# all students both language 
total=js.union(ps)
for names in total:
    print(names)
print(len(total))

# common stud from both
print(js.intersection(ps), len(js.intersection(ps)))

# unique java stud
print(js.difference(ps))

# unique python student
print(ps.difference(js))
