...
4. BaseException  it is used when we not many except blocks to handle many type of errors we use the base class that is BaseException which through message 
try:
    print(10/0)
