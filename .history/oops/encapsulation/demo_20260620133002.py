...
#called getter method to accesss private variable it returns __pin value outside the class but is same file  so this method is called inside the print fucntion
print(obj.getPin())
