...
#how to access the private var outside the class in same file , inside class we use getter and setter to access
#objectname._classname.__private_var_name
print(obj._demo.__pin)
