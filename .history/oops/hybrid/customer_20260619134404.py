...
class customer(savingaccount, loan):
    ...
    def __init__(self, name, bal):
        ...
        #and then name, bal para again passed from child classes (saving , loan ) to their parent class para cons that is bankaccount by using super().__init__(name, bal) from both child classes para cons it is possible becoz it is hierarrchical inheritance not multiple 
