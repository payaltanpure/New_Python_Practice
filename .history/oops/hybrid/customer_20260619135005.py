...
class customer(savingaccount, loan):
    ...
    def __init__(self, name, bal):
        ...
        #both parent classes(saving , laon) has para cons so confusion is para meter passing so one solution out of 4 solution is used that call it by classname so no confusion to of para passing to which class exactly directly defined in 
