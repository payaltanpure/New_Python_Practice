...
class sp(camera,mpp  ):
    ...
    def __init__(self, mp, playlist ,sim ):
        ...
        #3) 3rd way is to pass one para of parent class para cons by super and one by classname 
        super().__init__(mp)
        mpp.__init__(self, playlist)
        self.sim=sim
        

        #4) 4th way is to pass para to both parent class para con by classname 
