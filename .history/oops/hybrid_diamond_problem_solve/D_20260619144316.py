...
# A con Payal called only once not twice and also value to name var of A class a=setted only once using kwargs and confusion of passing para to para cons of parent classes using super is also resolved 