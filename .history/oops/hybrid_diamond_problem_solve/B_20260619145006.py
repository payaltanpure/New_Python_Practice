...
class B(A):
    ...
    #and salary the new independent para of this own B class is set to salary using key value pair set that is set in child class of B that is D becoz call to B parent class of D is from D parent class 
