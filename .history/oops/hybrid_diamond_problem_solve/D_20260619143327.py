...
#and we use super() call to call grand parent class para cons from child class D , but in that compiler gets confused that to which parent calss should receive which 