...
class D(B,C):
    ...
    def __init__(self,name, salary, age ):
        print("D cons")
        super().__init__(self, name, salary, age)
...
#and we use super() call to call grand parent class para cons from child class D super().__init__(self, name, salary, age) , but in that compiler gets confused that to which parent calss weather  should receive which para so we uses
