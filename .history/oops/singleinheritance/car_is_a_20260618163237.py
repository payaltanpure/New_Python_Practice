...
#c= car("Mercedes", 5000000, "White")= parent class para con is called auto from child class objkect craetion and we passed the values to parameters of that con 
