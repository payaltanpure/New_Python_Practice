...
# to cal sum of list ele so ans will be only one number so we used sum function outside and do sum of all nos by calling one by one no from the list into no variable and then store in 
