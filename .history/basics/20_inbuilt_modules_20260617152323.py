...
#payal
cudate= dt.date(2026,6,17)
birthdate= dt.date(2005,5,26)
print(cudate-birthdate)

#anu
cudate= dt.date(2026,6,17)
birthdate= dt.date(2009,12,27)
print(cudate-birthdate)

#papa
cudate= dt.date(2026,6,17)
birthdate= dt.date(1981,1,24)
print(cudate-birthdate)

#mummy
cudate= dt.date(2026,6,17)
birthdate= dt.date(1982,4,8)
print(cudate-birthdate)

#future data from current date
cudate= dt.datetime.now()
future= cudate+dt.timedelta(days=20) #future date from current date after 20 days 
print(future)

cudate= dt.datetime.now()
future= cudate+dt.timedelta(seconds=56000)  #future date from current date after 56 seconds
print(future)