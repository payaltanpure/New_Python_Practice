...
print(r.choice(f)) #gives any random value from the list
print(r.choices(f, k=2)) #gives any random values from list equal to k value from list, returns many v