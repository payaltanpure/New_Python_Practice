...
# and without using list output will be like this <map object at 0x00000243EAAABAF0> so we used list in above example but below we use sum function so ans is only one so 
