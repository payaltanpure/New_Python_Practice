...
#4. keyword variable length: to store the data in key value format like dictionary
def student(**data):
    print(data)
...
#normal function is used when we want to write many lines of code in it but lam
