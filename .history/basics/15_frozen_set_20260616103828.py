...
# frozenset- set - frozenset to add data into the frozenset  and make it mutable
...
# frozenset into set then adding element in it and again convert that set into intial frozenset , the initial frozenset 
# is not modified , so new frozen set is created at last step with new memory address 
